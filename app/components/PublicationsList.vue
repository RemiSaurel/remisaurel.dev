...
<template>
  <div class="flex flex-col gap-1">
    <component
      ...
      class="pressable px-3 py-4 transition-all duration-300 ease-out"
    ...
    >
      ...
      <div class="flex flex-col gap-2 md:hidden">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <span class="bg-neutral-100 px-1.5 py-0.5 text-xs text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400">{{ pub.venue }}</span>
            <svg
      ...
      <div class="grid-cols-[60px_1fr_auto] hidden items-start gap-4 md:grid">
        <span class="tabular-nums pt-1 text-xs text-neutral-400 dark:text-neutral-500">{{ formatDate(pub.date) }}</span>

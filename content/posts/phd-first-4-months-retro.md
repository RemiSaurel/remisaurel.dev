...
description: "A 4-month retrospective on my PhD journey"
date: 2025-02-24
---
...
Zotero is actually one of my best discoveries of this period. I knew it before, but I never really used it. It's a free and open-source reference management software to manage bibliographic data and related research materials. It's really powerful and I highly recommend it.
::

After a few weeks, I had a lot of papers in my Zotero library. I then started to tag them. My tags are organised in a way it allows my to prioritize my reading :tag{color="red"}[P1], :tag{color="yellow"}[P2], :tag{color="gray"}[P3] and :tag{color="cyan"}[BONUS]

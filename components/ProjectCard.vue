...
<template>
  <div
    class="relative min-w-42 min-h-24 dark:bg-zinc-7 border-t-solid bg-zinc-1/60 border-zinc-1 dark:border-zinc-5 rounded-lg p-4 flex flex-col gap-2 group overflow-clip"
  >
    <div
